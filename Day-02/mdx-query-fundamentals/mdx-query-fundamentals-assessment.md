# Assessment — MDX Query Fundamentals
...
**Q1. MDX queries run against what object?**

- A) A single SQL table
- B) A cube
- C) An index
- D) A Windows service only

**Q2. What does the WHERE clause usually act as in MDX?**
...
**Q3. Which object is a collection of members?**

- A) Tuple
- B) Set
- C) Measure group
- D) Attribute relationship
...
An analyst wants revenue by mine for 2024 only, but keeps getting all years. Explain how the slicer changes the dimensional context of the query.
...
Write three working MDX queries: by mine, by commodity type, and by quarter, all against the Assmang cube.
